	...
	<div class="row">
        <div class="row">
            ...
            <div class="col-sm-4 text-center">
                <figure>
                    <img src="profile.png" alt="" class="img-circle img-fluid">
                </figure>
            </div>
            <div class="col-sm-8">
                <h2>Jack Jackerman</h2>
                <p><strong>Class : </strong> IT </p>
                <p><strong>Buddy : </strong> Budi Budiman </p>
                <p><strong>Email : </strong> jackman@jack.com </p>
            </div>             
        </div>          
